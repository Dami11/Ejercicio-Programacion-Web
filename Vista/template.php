...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="agregar.php">Agregar Pedido</a>
      </li>      
      <li class="nav-item">
        <a class="nav-link" href="modificar.php">Editar Pedido</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="eliminar.php">Eliminar Pedido</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="listar.php">Ver Pedido</a>
      </li>
    </ul>
  ...
  <!-- Footer --> 
<footer class="p-0 mt-5 text-center text-lg-start bg-dark text-white">
